...
CREATE TABLE xep_luong_nhan_vien (
    id INT IDENTITY(1,1) PRIMARY KEY,

    nhan_vien_id INT NOT NULL,
    ngach_id INT NOT NULL,
    bac_luong_id INT NOT NULL,

    quyet_dinh_so NVARCHAR(50),
    ngay_xep_luong DATE,

    is_hien_hanh BIT DEFAULT 1,

    CONSTRAINT FK_xlnv_nhan_vien
        FOREIGN KEY (nhan_vien_id) REFERENCES nhan_vien(id),

    CONSTRAINT FK_xlnv_ngach
        FOREIGN KEY (ngach_id) REFERENCES ngach_cong_vien_chuc(id),

    CONSTRAINT FK_xlnv_bac_luong
        FOREIGN KEY (bac_luong_id) REFERENCES bac_luong(id)
);
ALTER TABLE luong
DROP CONSTRAINT FK_luong_muc_luong;

ALTER TABLE luong
DROP COLUMN muc_luong_id;
...
ALTER TABLE luong
ADD tong_thu_nhap DECIMAL(18,0),
    tong_khau_tru DECIMAL(18,0),
    luong_thuc_nhan DECIMAL(18,0);


SELECT name
FROM sys.foreign_keys
WHERE referenced_object_id = OBJECT_ID('loai_vien_chuc');

ALTER TABLE ngach_cong_vien_chuc
DROP CONSTRAINT FK_ngach_cong_vien_chuc_loai_vien_chuc;


TRUNCATE TABLE loai_vien_chuc;

alter table loai_vien_chuc drop column quyet_dinh_xep_loai, ngay_quyet_dinh_xep_loai

CREATE TABLE nhom_ngach (
...
ADD
    ...
    nhom_ngach_id INT NULL;

ALTER TABLE ngach_cong_vien_chuc
ADD CONSTRAINT FK_ngach_doi_tuong
FOREIGN KEY (doi_tuong_id)
REFERENCES loai_vien_chuc(id);

ALTER TABLE ngach_cong_vien_chuc
ADD CONSTRAINT FK_ngach_nhom
FOREIGN KEY (nhom_ngach_id)
REFERENCES nhom_ngach(id);

ALTER TABLE ngach_cong_vien_chuc drop column quyet_dinh_ban_ngach, ngay_ban_ngach

ALTER TABLE ngach_cong_vien_chuc
DROP CONSTRAINT FK_ngach_doi_tuong;
