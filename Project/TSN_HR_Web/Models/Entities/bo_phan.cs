...
public partial class bo_phan : BaseEntity
{
    ...
    public virtual co_so co_so { get; set; } = null!;

    public virtual ICollection<nhan_vien_bo_phan> nhan_vien_bo_phans { get; set; } =
        new List<nhan_vien_bo_phan>();
}
